...
import { Bar, BarChart, CartesianGrid, XAxis, YAxis, Line, LineChart, Pie, PieChart, RadialBar, RadialBarChart } from "recharts"
...
import { Terminal, Settings, User as UserIcon, CreditCard, Search as SearchIcon, Home as HomeIcon, CalendarIcon, ChevronsUpDown } from 'lucide-react';
...
export default function UiPage() {
  ...
  const ComponentSection: React.FC<{ title: string; children: React.ReactNode, className?: string }> = ({ title, children, className }) => (
    <section className={cn("mb-16 p-6 border-2 border-black rounded-none shadow-[8px_8px_0px_#000] bg-white", className)}>
      <h2 className="text-3xl font-black mb-6 border-b-2 border-black pb-2">{title}</h2>
  ...
  const SubSection: React.FC<{ title: string; children: React.ReactNode, className?: string }> = ({ title, children, className }) => (
    <div className={cn("mt-6 p-4 border-2 border-gray-300 rounded-none shadow-[3px_3px_0px_#ccc] bg-gray-50", className)}>
      <h3 className="text-xl font-bold mb-3 text-gray-700">{title}</h3>
      <div className="space-y-4 flex flex-wrap gap-4 items-start">
        {children}
      </div>
    </div>
  );
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12 font-space">
        <h1 className="text-5xl font-black mb-12 border-b-4 border-black pb-4 text-center">UI Component Showcase</h1>
        ...
        <ComponentSection title="Aspect Ratio">
          <div className="w-[450px]">
            <AspectRatio ratio={16 / 9} className="bg-yellow-300 border-2 border-black rounded-none shadow-[4px_4px_0_#000]">
              <img
        ...
        <ComponentSection title="Calendar">
          ...
          />
          <p className="text-sm font-semibold mt-2">Selected: {date?.toLocaleDateString()}</p>
        </ComponentSection>
            ...
            <CarouselContent>
              {Array.from({ length: 5 }).map((_, index) => (
                <CarouselItem key={index}>
                  <div className="p-1">
                    <Card>
                      <CardContent className="flex aspect-square items-center justify-center p-6 bg-yellow-200 border-2 border-black rounded-none">
        ...
        <ComponentSection title="Collapsible">
          <Collapsible>
            ...
            <CollapsibleContent className="mt-2 p-4 border-2 border-black rounded-none bg-gray-50 shadow-[2px_2px_0_#000]">
            ...
            <CommandDialog open={commandDialogOpen} onOpenChange={setCommandDialogOpen}>
              ...
              <CommandList>
                ...
                <CommandGroup heading="Links">
                  ...
                  <CommandItem onSelect={() => console.log("Selected Calendar")}>
        ...
        <ComponentSection title="Context Menu">
          <ContextMenu>
            <ContextMenuTrigger className="flex h-[150px] w-[300px] items-center justify-center rounded-none border-2 border-dashed border-black text-sm font-semibold shadow-[4px_4px_0_#000] bg-gray-100">
              Right-click here
            </ContextMenuTrigger>
        ...
        <ComponentSection title="Drawer">
          <div className="grid grid-cols-2 gap-2">
            <Drawer>
              <DrawerTrigger asChild><Button variant="outline">Open Drawer (Bottom)</Button></DrawerTrigger>
              <DrawerContent>
                <DrawerHeader>
            ...
            <p className="text-sm text-gray-600 p-4 border border-dashed border-black rounded-none">
              Note: Vaul (used by Drawer) is primarily for bottom sheets. For side drawers, consider the Sheet component.
            </p>
          </div>
        </ComponentSection>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="q1">What was your first pet's name?</SelectItem>
                        <SelectItem value="q2">What city were you born in?</SelectItem>
              ...
              <FormField
                ...
                name="sendEmails"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-none border-2 border-black p-4 shadow-[2px_2px_0_#000] bg-gray-50">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
        ...
        <ComponentSection title="Input OTP">
          <SubSection title="6-Digit OTP">
            <InputOTP maxLength={6} value={formValue} onChange={(value) => setFormValue(value)}>
              <InputOTPGroup>
        ...
        <ComponentSection title="Label">
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="label-demo-checkbox">Accept terms and conditions</Label>
          </div>
        </ComponentSection>
        ...
        <ComponentSection title="Menubar">
          <Menubar>
            ...
            <MenubarMenu><MenubarTrigger>Edit</MenubarTrigger>
              <MenubarContent>
                {/* ... more items */}
                  ...
                  <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        <Link
                          className="flex h-full w-full select-none flex-col justify-end rounded-none border-2 border-black bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md shadow-[2px_2px_0_#000] hover:bg-yellow-100"
                          href="/"
                        >
                    ...
                    <ListItem href="/ui" title="Introduction"> Re-usable components built using Radix UI and Tailwind CSS. </ListItem>
                    <ListItem href="/ui" title="Installation"> How to install dependencies and structure your app. </ListItem>
                    <ListItem href="/ui" title="Typography"> Styles for headings, paragraphs, lists...etc </ListItem>
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
              <NavigationMenuItem>
        ...
        <ComponentSection title="Resizable">
          <ResizablePanelGroup
            ...
            className="max-w-md rounded-none border-2 border-black shadow-[4px_4px_0_#000] min-h-[200px]"
          >
            <ResizablePanel defaultSize={50}>
              <div className="flex h-full items-center justify-center p-6 border-r-2 border-black">
        ...
        <ComponentSection title="Scroll Area">
          <ScrollArea className="h-72 w-60 rounded-none border-2 border-black shadow-[4px_4px_0_#000] p-2">
            <div className="p-4">
        ...
        <ComponentSection title="Sidebar (Trigger Example)">
          <SidebarProvider>
            <div className="flex items-center space-x-2">
              <SidebarTrigger />
              <p className="text-sm font-semibold">Toggle Sidebar (Conceptual - Full sidebar needs page structure)</p>
            </div>
            {/* <Sidebar>...</Sidebar> <SidebarInset>...</SidebarInset> */}
            <p className="text-xs text-gray-500 mt-2">Note: Full Sidebar component demo requires specific page layout structure.</p>
          </SidebarProvider>
        </ComponentSection>

        <ComponentSection title="Skeleton">
          <div className="flex items-center space-x-4">
            <Skeleton className="h-12 w-12 rounded-none border-2 border-black" /> {/* Avatar skeleton */}
            <div className="space-y-2">
        ...
        <ComponentSection title="Slider">
          <Slider
            ...
            className="w-[60%]"
          />
          <p className="text-sm mt-2">Current Value: {sliderValue[0]}</p>
        </ComponentSection>
        ...
        <ComponentSection title="Sonner Toasts">
          <Button onClick={() => sonnerToast("Event has been created.", {
            ...
            action: { label: "Undo", onClick: () => console.log("Sonner Undo!") },
          })}>
            Show Sonner Toast
          </Button>
          <Button variant="destructive" onClick={() => sonnerToast.error("Something went wrong!", {
          ...
          <Button
            onClick={() => {
              shadcnToast({
                ...
                action: (
                  <Button variant="outline" size="sm" onClick={() => console.log("Shadcn Toast Undo!")}>Undo</Button>
                ),
              })
            }}
          >
        ...
        <ComponentSection title="Toggle">
          <SubSection title="Variants & Sizes">
            ...
            <Toggle size="lg" aria-label="Toggle strikethrough">S</Toggle>
          </SubSection>
          <SubSection title="With Text">
            <Toggle aria-label="Toggle notifications"><Settings className="mr-2 h-4 w-4" /> Notifications</Toggle>
          </SubSection>
          <SubSection title="Pressed State">
            <Toggle pressed aria-label="Toggle microphone"><UserIcon className="h-4 w-4" /></Toggle>
          </SubSection>
        </ComponentSection>
        ...
        <ComponentSection title="Tooltip">
          <TooltipProvider>
            ...
            <Tooltip>
              <TooltipTrigger asChild><Button variant="default" size="icon"><SearchIcon /></Button></TooltipTrigger>
