...
} from "recharts"; // Renamed PieChart to avoid conflict
...
const componentSectionsList: ComponentSectionItem[] = [
  ...
  },
  {
    ...
    name: "Form",
    icon: <Palette className="mr-2 size-4" />,
    variations: [{ id: "form-example", name: "Example Usage" }],
  },
  {
    id: "hoverCard",
    name: "Hover Card",
  ...
  },
  {
    ...
    variations: [
      { id: "inputOtp-6digit", name: "6-Digit" },
      { id: "inputOtp-4digit", name: "4-Digit" },
    ],
  },
  ...
  },
  {
    ...
    icon: <ChevronsUpDown className="mr-2 size-4" />,
    variations: [
      { id: "select-basic", name: "Basic" },
      { id: "select-groups", name: "With Groups" },
    ],
  },
  {
    id: "separator",
  ...
  },
  {
    ...
    name: "Sidebar",
    icon: <Palette className="mr-2 size-4" />,
    variations: [{ id: "sidebar-trigger-example", name: "Trigger Example" }],
  },
  {
    id: "skeleton",
    name: "Skeleton",
  ...
  { id: "slider", name: "Slider", icon: <Palette className="mr-2 size-4" /> },
  {
    ...
    icon: <MessageSquare className="mr-2 size-4" />,
    variations: [
      { id: "sonner-default", name: "Default" },
      { id: "sonner-destructive", name: "Destructive" },
    ],
  },
  ...
  },
  {
    ...
    icon: <MessageSquare className="mr-2 size-4" />,
    variations: [
      { id: "toastShadcn-default", name: "Default" },
      { id: "toastShadcn-destructive", name: "Destructive" },
    ],
  },
  {
    id: "toggle",
    ...
    variations: [
      ...
      { id: "toggle-texticon", name: "With Text/Icon" },
    ],
  },
  {
    id: "toggleGroup",
    ...
    icon: <Palette className="mr-2 size-4" />,
    variations: [
      { id: "toggle-group-multiple", name: "Multiple" },
      { id: "toggle-group-single", name: "Single (Outline)" },
    ],
  },
  {
    id: "tooltip",
...
} satisfies ChartConfig; // Use your theme colors
      ...
      (entries) => {
        for (const entry of entries) {
          if (entry.isIntersecting) {
            ...
            const mainComponent = componentSectionsList.find(
              (comp) =>
                comp.id === sectionId ||
                comp.variations?.some((v) => v.id === sectionId),
            );
            if (mainComponent) {
  ...
  return (
    <Layout>
      <style jsx global>{`
        ...
        } /* Smooth scroll for URL hash changes */
      `}</style>
      <div className="flex min-h-[calc(100vh-var(--header-height))] flex-col bg-gray-100 font-space md:flex-row">
            ...
            <ul className="space-y-0">
              {componentSectionsList.map((section) => (
                <li key={section.id}>
                  ...
                  {section.variations &&
                    activeSidebarSection === section.id && (
                      <ul className="mb-0.5 ml-3 mt-0 space-y-0 border-l-2 border-gray-500 bg-yellow-50 py-1 pl-4 shadow-[inset_2px_0px_0px_#eab308]">
                        {section.variations.map((variation) => (
                          <li key={variation.id}>
                            <button
                              ...
                              className="flex w-full items-center rounded-none px-2 py-0.5 text-left text-xs font-semibold text-gray-700 transition-colors duration-100 hover:bg-yellow-200 hover:text-black"
                            >
        ...
        >
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                      onClick={() =>
                        sonnerToast.error("Account Deletion Confirmed (Demo)")
                      }
                    >
                      Yes, delete
                    </AlertDialogAction>
            ...
            <PropsTable
              data={[
                ...
                },
                {
                  ...
                  description: "Callback on open state change.",
                },
              ]}
            />
          </ComponentDocSection>
          ...
          >
            ...
            <VariationDisplay title="16:9 Aspect Ratio">
              <div className="w-[300px] sm:w-[400px]">
                <AspectRatio
                  ratio={16 / 9}
                  className="flex items-center justify-center rounded-none border-2 border-black bg-yellow-300 shadow-[4px_4px_0_#000]"
                >
                  <span className="text-2xl font-bold text-black">16:9</span>
                </AspectRatio>
              </div>
            </VariationDisplay>
            <CodeBlock
              code={`<AspectRatio ratio={16 / 9} className="bg-yellow-300">\n  {/* Content */}\n</AspectRatio>`}
            />
            <VariationDisplay title="1:1 (Square) Aspect Ratio">
              <div className="w-[200px]">
                <AspectRatio
                  ratio={1 / 1}
                  className="flex items-center justify-center rounded-none border-2 border-black bg-indigo-300 shadow-[4px_4px_0_#000]"
                >
            ...
            <CodeBlock
              code={`<AspectRatio ratio={1 / 1}>{/* Square Content */}</AspectRatio>`}
            />
            <PropsTable
              data={[
                {
          ...
          <ComponentDocSection
            id="avatar"
            title="Avatar"
            description="Displays an image representing a user or entity, with a fallback."
          >
            <p className="mb-4 text-sm">
              Import:{" "}
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
            ...
            <VariationDisplay title="Image and Fallback">
              ...
              <Avatar>
                <AvatarImage src="/non-existent-image.png" alt="No image" />
            ...
            <PropsTable
              data={[
                ...
                {
                  prop: "(AvatarFallback) children",
                  type: "ReactNode",
                  description: "Content for fallback (e.g., initials).",
                },
              ]}
            />
          </ComponentDocSection>
          ...
          <ComponentDocSection
            id="badge"
            title="Badge"
            description="Small, highlighted pieces of information."
          >
            <p className="mb-4 text-sm">
              Import:{" "}
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
          ...
          >
            ...
            <CodeBlock
              code={`<Breadcrumb><BreadcrumbList>...</BreadcrumbList></Breadcrumb>`}
            />
          ...
          >
            ...
            />
            <VariationDisplay id="button-icon" title="With Icon">
              <Button>
                <UserIcon className="mr-2 size-4" /> Login
              </Button>
            </VariationDisplay>
            <CodeBlock
              code={`<Button><UserIcon className="mr-2 h-4 w-4" /> Login</Button>`}
            />
            <VariationDisplay id="button-disabled" title="Disabled">
              <Button disabled>Disabled</Button>
            </VariationDisplay>
            <CodeBlock code={`<Button disabled>Disabled</Button>`} />
            <VariationDisplay id="button-aschild" title="As Child">
              <Button asChild variant="link">
                <a href="#button">Link Button</a>
              </Button>
            </VariationDisplay>
            <CodeBlock
              code={`<Button asChild variant="link"><a href="#">Link</a></Button>`}
            />
            <PropsTable
              data={[
                {
            ...
            <PropsTable
              data={[
                ...
                },
                {
                  prop: "onSelect",
                  type: "function",
                  description: "Callback on date selection.",
                },
              ]}
            />
          </ComponentDocSection>
          ...
          >
            ...
            <VariationDisplay title="Simple Carousel">
              <Carousel className="mx-auto w-full max-w-[250px] sm:max-w-xs">
                <CarouselContent>
                  {Array.from({ length: 3 }).map((_, index) => (
                    <CarouselItem key={index}>
                      <div className="p-1">
                        <Card>
                          <CardContent className="flex aspect-square items-center justify-center rounded-none border-2 border-black bg-yellow-200 p-4 sm:p-6">
            ...
            <CodeBlock
              code={`<Carousel><CarouselContent>{/* <CarouselItem>...</CarouselItem> */}</CarouselContent><CarouselPrevious/><CarouselNext/></Carousel>`}
            />
            <PropsTable
              data={[
                {
          ...
          <ComponentDocSection
            id="chart"
            title="Chart"
            description="Component for displaying charts using Recharts."
          >
            <p className="mb-4 text-sm">
              Import:{" "}
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
              ...
              and Recharts components.
            </p>
            <VariationDisplay id="chart-bar" title="Bar Chart Example">
              <ChartContainer
                config={uiChartConfigInstance}
                className="min-h-[200px] w-full max-w-lg"
              >
                <BarChart accessibilityLayer data={uiChartDataInstance}>
          ...
          >
            ...
            <VariationDisplay id="checkbox-basic" title="With Label">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="terms-cb">Accept terms</Label>
              </div>
            </VariationDisplay>
            <CodeBlock
            ...
            <VariationDisplay id="checkbox-disabled" title="Disabled State">
              <div className="flex items-center space-x-2">
                <Checkbox id="terms-cb-dis" disabled />
                <Label htmlFor="terms-cb-dis" className="opacity-50">
                  Disabled Checkbox
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox id="terms-cb-dis-chk" checked disabled />
                <Label htmlFor="terms-cb-dis-chk" className="opacity-50">
                  Disabled Checked
                </Label>
              </div>
            </VariationDisplay>
            ...
            <PropsTable
              data={[
                ...
                },
                {
                  ...
                  description: "Callback on state change.",
                },
                {
                  prop: "disabled",
                  type: "boolean",
          ...
          >
            <p className="mb-4 text-sm">
              ...
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
                import{" "}
                {"{ Collapsible, CollapsibleTrigger, CollapsibleContent }"} from
            ...
            <VariationDisplay id="collapsible-basic" title="Basic Collapsible">
              <Collapsible className="w-full max-w-md">
                ...
                <CollapsibleContent className="mt-0.5 rounded-none border-2 border-t-0 border-black bg-gray-50 p-4 shadow-[2px_2px_0_#000]">
                  This is the collapsible content area. It can contain any other
                  elements or components. Neo-Brutalism encourages clear visual
                  separation.
                </CollapsibleContent>
              </Collapsible>
            </VariationDisplay>
        ...
        Detailed content goes here...
            ...
            <PropsTable
              data={[
                ...
                },
                {
                  prop: "disabled",
                  type: "boolean",
                  description: "Disables the collapsible trigger.",
                },
              ]}
            />
          </ComponentDocSection>
          ...
          >
            <p className="mb-4 text-sm">
              Import:{" "}
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
                import {"{ Command, CommandInput, ... }"} from
              ...
              <Command className="w-full max-w-md rounded-none border-2 border-black shadow-[4px_4px_0_#000]">
                ...
                <CommandList>
                  ...
                  <CommandGroup heading="Suggestions">
                    <CommandItem
                      onSelect={() => sonnerToast("Selected Calendar")}
                    >
                      Calendar
                    </CommandItem>
                    <CommandItem
                      onSelect={() => sonnerToast("Selected Emoji Search")}
                    >
                      Search Emoji
                    </CommandItem>
                  </CommandGroup>
                  ...
                  <CommandGroup heading="Settings">
                    <CommandItem
                      onSelect={() => sonnerToast("Selected Profile")}
                    >
...
<CommandDialog open={open} onOpenChange={setOpen}>
  {/* CommandInput, CommandList, etc. */}
            ...
            <PropsTable
              data={[
                {
                  prop: "(CommandDialog) open",
                  type: "boolean",
                  description: "Controls dialog visibility.",
                },
                {
                  prop: "(CommandDialog) onOpenChange",
                  type: "(open: boolean)=>void",
                  description: "Callback for dialog state change.",
                },
                {
          ...
          >
            <p className="mb-4 text-sm">
              Import:{" "}
              <code className="rounded-none border border-black bg-gray-200 p-1 text-xs">
                import {"{ ContextMenu, ContextMenuTrigger, ... }"} from
                "@/components/ui/context-menu";
              </code>
            </p>
            <VariationDisplay id="contextMenu-basic" title="Basic Context Menu">
              <ContextMenu>
                <ContextMenuTrigger className="flex h-[150px] w-[300px] items-center justify-center rounded-none border-2 border-dashed border-black bg-gray-100 text-sm font-semibold shadow-[3px_3px_0_#ccc]">
                  Right-click this area
                </ContextMenuTrigger>
                <ContextMenuContent className="w-64">
                  <ContextMenuItem
                    inset
                    onSelect={() => sonnerToast("Back action")}
                  >
                  ...
                  <ContextMenuItem
                    inset
                    onSelect={() => sonnerToast("Reload action")}
                  >
                  ...
                  <ContextMenuCheckboxItem
                    checked
                    onCheckedChange={() => sonnerToast("Toggle Bookmark Bar")}
                  >
                    Show Bookmarks Bar
                  </ContextMenuCheckboxItem>
                  <ContextMenuSeparator />
  ...
  <ContextMenuContent>
    ...
    <ContextMenuSub>
        ...
        <ContextMenuSubContent>
          ...
          {/* Final placeholder */}
          <section className="mt-20 border-t-4 border-black py-12 text-center">
            <h2 className="text-2xl font-black text-black">
              End of UI Kit Showcase
            </h2>
            <p className="mt-2 font-semibold text-gray-700">
              Explore the sidebar to jump to specific components.
            </p>
          </section>
        </main>
      </div>
