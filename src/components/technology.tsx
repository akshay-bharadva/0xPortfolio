...
// import Link from "next/link"; // Not needed if all links are external

type TechnologyProps = PropsWithChildren; // Renamed Props

interface TechItem {
  // Renamed Tech to TechItem
  name: string;
  href: string;
  desc: string;
}
...
const TECHNOLOGIES: TechItem[] = [
  // Renamed Technologies to TECHNOLOGIES
  {
    name: "React",
        ...
        {TECHNOLOGIES.map((tech) => (
          ...
          >
            ...
            <a
              ...
              target="_blank"
              className="group mb-1 inline-flex items-center self-start text-xl font-bold text-indigo-700 transition-colors hover:bg-yellow-200 hover:text-indigo-900 hover:underline" // self-start for link
            >
              <span>{tech.name}</span>
