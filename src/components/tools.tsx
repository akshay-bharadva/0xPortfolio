...
type ToolsProps = PropsWithChildren; // Renamed Props

interface ToolItem {
  // Renamed Tool to ToolItem
  name: string;
  href: string;
  desc: string;
}
...
const USED_TOOLS: ToolItem[] = [
  // Renamed UsedTools to USED_TOOLS
  {
  ...
  {
    name: "Slack",
    href: "https://slack.com/intl/en-in/", // Specific to India, maybe use generic slack.com?
