...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      props.checked && "data-[state=checked]:border-black", // If primary is not black, this ensures checked border is black
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        props.checked && "data-[state=checked]:border-black", // If primary is not black
      )}
    />
  </SwitchPrimitives.Root>
));
